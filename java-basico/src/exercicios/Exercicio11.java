...
public class Exercicio11 {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showInternalMessageDialog(null, " VAMOS EFETUAR A MULTIPLICAÇÃO DE DOIS VALORES : ");
		...
		JOptionPane.showInternalMessageDialog(null, "O resultado da multiplicação do primeiro valor : " + valor1
